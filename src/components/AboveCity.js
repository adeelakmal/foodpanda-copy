    ...
    <>
      <div className="photoWithText">
        ...
        <div className="z-50 CitiesMargin texty">
          <div className="text-lg font-light leading-big ManyMore">
            You prepare the food, we handle the rest
          </div>
          <div className="absolute top-0 font-Open font-bold text-gray-300/25 px-12 fontCities">
            Partners
          </div>
        </div>
      </div>
      <div className="section">
        ...
        <button className="buttonGetstarted" type="button">
          Get Started
        </button>
      </div>
    </>
