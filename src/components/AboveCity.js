    ...
    return (
      ...
      <div className="relative mt-24">
          <div className="relative ml-12 bottom-1" style={{zIndex: "-1"}}>
            <div className="absolute text-lg font-light  pl-3 top-0" style = {{fontSize: "27px"}}> You prepare the food, we handle the rest</div>
            <div className="relative bottom-6 font-Open font-bold leading-small text-blackG/10 px-12 pl-3" style={{fontSize: width/5,color:'#000000A'}}>Partners</div>
          </div>
        <div style={{zIndex: "1"}}>
        <img
