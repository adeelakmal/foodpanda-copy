...
export default function Text() {
  ...
  if (width > 1000) {
    return (
      <>
        <div
          className="relative font-Open p-24 top-[100px]"
          style={{ maxWidth: "1280px" }}
        >
          <h1 className="font-bold py-3" style={{ fontSize: "2rem" }}>
          ...
          <h1 className="font-bold py-3" style={{ fontSize: "1.5rem" }}>
            Frequently Asked Questions
          </h1>
          <h1 className="font-bold py-3" style={{ fontSize: "1.1rem" }}>
          ...
          <p>
            Find a restaurant. Enter your delivery address in the location form
            to see all the places that deliver to your location. It can be your
            home, office, a hotel or even parks! Choose your dishes. Browse the
            menu of the chosen restaurant, select your dishes and add them to
            your basket. When you are done, press the "Checkout" button.
            Checkout & Payment. Check your order, payment method selection and
            exact delivery address. Simply follow the checkout instructions from
            there. Delivery. We will send you an email and SMS confirming your
            order and delivery time. Sit back, relax and wait for piping hot
            food to be conveniently delivered to you!.
          </p>
          <h1 className="font-bold py-3" style={{ fontSize: "1.1rem" }}>
          ...
          <p>
            ...
            else. During checkout, just update the name and delivery address of
            the person you're ordering for. Please keep in mind that if the
            delivery details are not correct and the order cannot be delivered,
            we won't be able to process a refund.
          </p>
          <h1 className="font-bold py-3" style={{ fontSize: "1.1rem" }}>
          ...
          <p>
            ...
            order online. For example, KFC, McDonald's, Pizza Hut, OPTP,
            Hardee's, Domino's, Kababjees and many-many more! In order to check
            all the restaurants near you that deliver, just type in your address
            and discover all the available places.
          </p>
          <h1 className="font-bold py-3" style={{ fontSize: "1.1rem" }}>
          ...
          <p>
            ...
            depends on the restaurant you order from and is indicated during
    ...
    return (
      <>
        <div className="relative font-Open" style={{ maxWidth: "1280px" }}>
          <h1 className="font-bold py-3" style={{ fontSize: "2rem" }}>
            Order food and groceries online from the best restaurants and shops
            on foodpanda
          </h1>
